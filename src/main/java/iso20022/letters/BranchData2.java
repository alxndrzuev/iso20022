 ...
 *       &lt;sequence>
 *         &lt;element name="Id" type="{urn:iso:std:iso:20022:tech:xsd:auth.026.001.01}Max35Text" minOccurs="0"/>
...
@XmlType(name = "BranchData2", namespace = "urn:iso:std:iso:20022:tech:xsd:auth.026.001.01", propOrder = {
    "id",
    "nm",
    "pstlAdr"
})
