 ...
 *         &lt;element name="SchmeNm" type="{urn:iso:std:iso:20022:tech:xsd:auth.026.001.01}PersonIdentificationSchemeName1Choice" minOccurs="0"/>
...
@XmlType(name = "GenericPersonIdentification1", namespace = "urn:iso:std:iso:20022:tech:xsd:auth.026.001.01", propOrder = {
    "id",
    "schmeNm",
    "issr"
})
