...
@XmlType(name = "Cheque7", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", propOrder = {
    "chqTp",
    "chqNb",
    "chqFr",
    "dlvryMtd",
...
public class Cheque7 {
    ...
    @XmlElement(name = "ChqTp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    @XmlSchemaType(name = "string")
    protected ChequeType2Code chqTp;
    @XmlElement(name = "ChqNb", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected String chqNb;
    @XmlElement(name = "ChqFr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected NameAndAddress10 chqFr;
    @XmlElement(name = "DlvryMtd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected ChequeDeliveryMethod1Choice dlvryMtd;
    @XmlElement(name = "DlvrTo", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected NameAndAddress10 dlvrTo;
    @XmlElement(name = "InstrPrty", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    @XmlSchemaType(name = "string")
    protected Priority2Code instrPrty;
    @XmlElement(name = "ChqMtrtyDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar chqMtrtyDt;
    @XmlElement(name = "FrmsCd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected String frmsCd;
    @XmlElement(name = "MemoFld", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected List<String> memoFld;
    @XmlElement(name = "RgnlClrZone", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected String rgnlClrZone;
    @XmlElement(name = "PrtLctn", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected String prtLctn;
    @XmlElement(name = "Sgntr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
