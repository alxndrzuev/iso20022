...
@XmlType(name = "Garnishment1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", propOrder = {
    "tp",
    "grnshee",
    "grnshmtAdmstr",
    "refNb",
...
public class Garnishment1 {
    ...
    @XmlElement(name = "Tp", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", required = true)
    protected GarnishmentType1 tp;
    @XmlElement(name = "Grnshee", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected PartyIdentification43 grnshee;
    @XmlElement(name = "GrnshmtAdmstr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    ...
    @XmlElement(name = "RmtdAmt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected ActiveOrHistoricCurrencyAndAmount rmtdAmt;
    @XmlElement(name = "FmlyMdclInsrncInd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
    protected Boolean fmlyMdclInsrncInd;
    @XmlElement(name = "MplyeeTermntnInd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
