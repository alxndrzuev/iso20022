...
@XmlType(name = "DatePeriodDetails", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", propOrder = {
    "frDt",
    "toDt"
})
public class DatePeriodDetails {

    @XmlElement(name = "FrDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar frDt;
    @XmlElement(name = "ToDt", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", required = true)
    @XmlSchemaType(name = "date")
