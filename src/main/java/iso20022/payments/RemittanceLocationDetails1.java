...
@XmlType(name = "RemittanceLocationDetails1", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", propOrder = {
    "mtd",
    "elctrncAdr",
    "pstlAdr"
})
public class RemittanceLocationDetails1 {
    ...
    @XmlElement(name = "Mtd", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", required = true)
    @XmlSchemaType(name = "string")
    protected RemittanceLocationMethod2Code mtd;
    @XmlElement(name = "ElctrncAdr", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
