...
@XmlType(name = "TaxInformation3", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06", propOrder = {
    "cdtr",
    "dbtr",
    "admstnZn",
    "refNb",
...
public class TaxInformation3 {
    ...
    @XmlElement(name = "AdmstnZn", namespace = "urn:iso:std:iso:20022:tech:xsd:pain.001.001.06")
